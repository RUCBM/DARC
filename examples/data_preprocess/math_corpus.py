...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--local_dataset_path",
        default=os.getenv("LOCAL_DATASET_PATH"),
    ...
    if not args.local_dataset_path or not args.local_save_dir:
        raise ValueError("LOCAL_DATASET_PATH and LOCAL_SAVE_DIR are required.")
